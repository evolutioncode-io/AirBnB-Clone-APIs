class Api::V1::RoomsController < ApplicationController
    ...
    def index 
        ...
        render json: {
             rooms: rooms.map{ |room| room.attributes.merge(image: room.cover_photo('small'), instant: room.instant != "Request")},
             is_success: true
        }, status: :ok
    end
    ...
    def your_listings
        ...
        render json: {
            rooms: rooms.map {|r| r.attributes.merge(image: r.cover_photo('small'), instant: r.instant != "Request")},
            is_success: true
        }, status: :ok
    end
end